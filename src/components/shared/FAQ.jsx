...
const FAQ1 = () => {
  return (
    <div className='w-[97%] mx-auto'>
        <div className="   ">
  <table className="table text-justify p-3">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>1) What is React.js and Explain the concept of components in React?</td>
      ...
      <tr className='bg-[darkcyan] text-[white]'>
        ...
        <td>2) What is JSX in React, and how does it work? </td>
...
JSX converts HTML tags into react elements.</td>
      ...
      <tr>
        ...
        <td>3) What is the Virtual DOM, and how does React use it to optimize performance? 
        </td>
      ...
      <tr className='bg-orange-600 text-[white] '>
        ...
        <td>  4) Explain the concept of  props  in React and how they are used?
        </td>
...
To send props into a component, use the same syntax as HTML attributes: </td>
      ...
      <tr>
        ...
        <td>5) What is "state" in React, and how does it differ from props? 
        </td>
    ...
    The key difference between state and props is that state is managed within a component, while props are passed from a parent component to a child component. State is used to manage internal component data, while props are used to pass data from a parent component to a child component.
      ...
      <tr className='bg-[darkcyan] text-[white]'>
        ...
        <td>6) Explain the useState hook and provide an example of how it is used 
        </td>
...
<br /> </td>
      ...
      <tr>
        ...
        <td> 7) What is the purpose of the useEffect hook in React, and when would you use it? 
        </td>
